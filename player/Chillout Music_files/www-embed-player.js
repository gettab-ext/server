...
function Cf(a){return-1<navigator.userAgent.indexOf("Sony/COM2")&&!Af(a,9,1,58)?!1:!0}
function Df(a){return bd?!Af(a,11,2):ad?!Af(a,11,3):!Bf(a)}
;function Ef(a,b,c){if(b){a=v(a)?ke(a):a;var d=hb(c.attrs);d.tabindex=0;var e=hb(c.params);e.flashvars=Cd(c.args);if(ec){d.classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000";e.movie=b;b=document.createElement("object");for(var f in d)b.setAttribute(f,d[f]);for(f in e)d=document.createElement("param"),d.setAttribute("name",f),d.setAttribute("value",e[f]),b.appendChild(d)}else{d.type="application/x-shockwave-flash";d.src=b;b=document.createElement("embed");b.setAttribute("name",d.id);for(f in d)b.setAttribute(f,
d[f]);for(f in e)b.setAttribute(f,e[f])}e=document.createElement("div");e.appendChild(b);a.innerHTML=e.innerHTML}}
function Ff(a,b,c){if(a&&a.attrs&&a.attrs.id){a=We(a);var d=!!b,e=ke(a.attrs.id),f=e?e.parentNode:null;if(e&&f){if(window!=window.top){var h=null;if(document.referrer){var k=document.referrer.substring(0,128);Hd(k)||(h=k)}else h="unknown";h&&(d=!0,a.args.framer=h)}h=zf.getInstance();if(Af(h,a.minVersion)){var k=Gf(a,h),m="";-1<navigator.userAgent.indexOf("Sony/COM2")||(m=e.getAttribute("src")||e.movie);(m!=k||d)&&Ef(f,k,a);Df(h)&&Hf()}else If(f,a,h);c&&c()}else H(function(){Ff(a,b,c)},50)}}
function If(a,b,c){0==c.b&&b.fallback?b.fallback():0==c.b&&b.fallbackMessage?b.fallbackMessage():a.innerHTML='<div id="flash-upgrade">'+cc()+"</div>"}
function Gf(a,b){return Bf(b)&&a.url||Cf(b)&&a.urlV9As2||a.url}
function Hf(){var a=ke("flash10-promo-div"),b=vf(qf.getInstance(),107);a&&!b&&xf(a)}
;function Jf(a){if(window.spf){var b=a.match(Kf);spf.style.load(a,b?b[1]:"",void 0)}else Lf(a)}
function Lf(a){var b=Mf(a),c=document.getElementById(b),d=c&&C(c,"loaded");d||c&&!d||(c=Nf(a,b,function(){C(c,"loaded")||(Cb(c,"loaded","true"),J(b),H(ma(pc,b),0))}))}
...
function Mf(a){var b=document.createElement("a");Bb(b,a);a=b.href.replace(/^[a-zA-Z]+:\/\//,"//");return"css-"+Ga(a)}
var Kf=/cssbin\/(?:debug-)?([a-zA-Z0-9_-]+?)(?:-2x|-web|-rtl|-vfl|.css)/;var Of;var Pf=lb,Pf=Pf.toLowerCase();if(-1!=Pf.indexOf("android")){var Qf=Pf.match(/android\D*(\d\.\d)[^\;|\)]*[\;\)]/);if(Qf)Of=Number(Qf[1]);else{var Rf={cupcake:1.5,donut:1.6,eclair:2,froyo:2.2,gingerbread:2.3,honeycomb:3,"ice cream sandwich":4,jellybean:4.1},Sf=Pf.match("("+cb(Rf).join("|")+")");Of=Sf?Rf[Sf[0]]:0}}else Of=void 0;var Tf=['video/mp4; codecs="avc1.42001E, mp4a.40.2"','video/webm; codecs="vp8.0, vorbis"'],Uf=['audio/mp4; codecs="mp4a.40.2"'];function Vf(a){D.call(this);this.b=[];this.f=a||this}
...
;var Lh={"api.invalidparam":2,auth:150,"drm.auth":150,heartbeat:150,"html5.unsupportedads":5,"fmt.noneavailable":5,"fmt.decode":5,"fmt.unplayable":5,"html5.missingapi":5,"html5.unsupportedlive":5,"drm.unavailable":5};function Mh(a,b){D.call(this);this.o=this.i=a;this.V=b;this.u=!1;this.f={};this.qa=this.U=null;this.Z=new F;Ub(this,ma(E,this.Z));this.j={};this.D=this.Ha=this.g=this.Ta=this.b=null;this.ia=!1;this.F=this.l=this.K=this.L=null;this.Ia={};this.Uc=["onReady"];this.ka=new Vf(this);Ub(this,ma(E,this.ka));this.yb=null;this.Xb=NaN;this.la={};Nh(this);this.na("onDetailedError",w(this.Ed,this));this.na("onTabOrderChange",w(this.Zc,this));this.na("onTabAnnounce",w(this.Yb,this));this.na("WATCH_LATER_VIDEO_ADDED",
...
function Ph(a,b){a.Ta=b;a.b=b.clone();a.g=a.b.attrs.id||a.g;"video-player"==a.g&&(a.g=a.V,a.b.attrs.id=a.V);a.o.id==a.g&&(a.g+="-player",a.b.attrs.id=a.g);a.b.args.enablejsapi="1";a.b.args.playerapiid=a.V;a.Ha||(a.Ha=Sh(a,a.b.args.jsapicallback||"onYouTubePlayerReady"));a.b.args.jsapicallback=null;var c=a.b.attrs.width;c&&(a.o.style.width=cf(Number(c)||c,!0));if(c=a.b.attrs.height)a.o.style.height=cf(Number(c)||c,!0)}
...
function Qh(a,b){if(!a.isDisposed()){if(!b){var c;if(!(c=!a.b.html5&&Th(a))){if(!p(a.b.disable.html5)){var d;c=!0;void 0!=a.b.args.deviceHasDisplay&&(c=a.b.args.deviceHasDisplay);if(2.2==Of)d=!0;else{a:{var e=c;c=r("yt.player.utils.videoElement_");c||(c=document.createElement("video"),q("yt.player.utils.videoElement_",c,void 0));try{if(c.canPlayType)for(var e=e?Tf:Uf,f=0;f<e.length;f++)if(c.canPlayType(e[f])){d=null;break a}d="fmt.noneavailable"}catch(h){d="html5.missingapi"}}d=!d}d&&(d=Wh(a)||a.b.assets.js);
...
g.pe=function(){if(!this.ia){var a=Wh(this);a&&"html5"==Xh(this)?(this.D="html5",this.u||this.Ea()):(Yh(this),this.D="html5",a&&this.K?(this.i.appendChild(this.K),this.Ea()):(this.b.loaded=!0,this.L=w(function(){var a=this.i,c=this.b.clone();r("yt.player.Application.create")(a,c);this.Ea()},this),this.ia=!0,a?this.L():(qc(this.b.assets.js,this.L),Jf(this.b.assets.css))))}};
...
if("flash"==Xh(this))this.D="flash",this.u||(b?this.Ea():Ff(a,!1,w(this.Ea,this)));else{Yh(this);this.D="flash";this.b.loaded=!0;if(b)b=zf.getInstance(),b=Bf(b)||!Cf(b)?a.url:a.urlV9As2,window!=window.top&&document.referrer&&(a.args.framer=document.referrer.substring(0,128)),Ef(this.i,b,a);else{b=this.i;b=v(b)?ke(b):b;a=We(a);if(window!=window.top){var c=null;document.referrer&&(c=document.referrer.substring(0,128));a.args.framer=c}c=zf.getInstance();Af(c,a.minVersion)?(c=Gf(a,c),Ef(b,c,a)):If(b,
a,c)}this.Ea()}};
g.kc=function(){Vh(this).focus()};
function Vh(a){var b=ke(a.g);!b&&a.o&&a.o.querySelector&&(b=a.o.querySelector("#"+a.g));return b}
g.Ea=function(){if(!this.isDisposed()){var a=Vh(this),b=!1;try{a&&a.getApiInterface&&a.getApiInterface()&&(b=!0)}catch(f){}if(b)if(this.ia=!1,a.isNotServable&&a.isNotServable(this.b.args.video_id))Uh(this);else{Nh(this);this.u=!0;a=Vh(this);a.addEventListener&&(this.U=Zh(this,a,"addEventListener"));a.removeEventListener&&(this.qa=Zh(this,a,"removeEventListener"));for(var b=a.getApiInterface(),b=b.concat(a.getInternalApiInterface()),c=0;c<b.length;c++){var d=b[c];this.f[d]||(this.f[d]=Zh(this,a,d))}for(var e in this.j)this.U(e,
this.j[e]);Rh(this);this.Ha&&this.Ha(this.f);this.Z.w("onReady",this.f)}else this.Xb=H(w(this.Ea,this),50)}};
...
function Nh(a){a.u=!1;if(a.qa)for(var b in a.j)a.qa(b,a.j[b]);for(var c in a.la)I(parseInt(c,10));a.la={};a.U=null;a.qa=null;for(var d in a.f)a.f[d]=null;a.f.addEventListener=w(a.na,a);a.f.removeEventListener=w(a.be,a);a.f.destroy=w(a.dispose,a);a.f.getLastError=w(a.gd,a);a.f.getPlayerType=w(a.hd,a);a.f.getCurrentVideoConfig=w(a.fd,a);a.f.loadNewVideoConfig=w(a.Tb,a);a.f.isReady=w(a.Ae,a)}
g.Ae=function(){return this.u};
g.na=function(a,b){if(!this.isDisposed()){var c=Sh(this,b);if(c){if(!A(this.Uc,a)&&!this.j[a]){var d=$h(this,a);this.U&&this.U(a,d)}this.Z.subscribe(a,c);"onReady"==a&&this.u&&H(ma(c,this.f),0)}}};
g.be=function(a,b){if(!this.isDisposed()){var c=Sh(this,b);c&&this.Z.unsubscribe(a,c)}};
function Sh(a,b){var c=b;if("string"==typeof b){if(a.Ia[b])return a.Ia[b];c=function(){var a=r(b);a&&a.apply(l,arguments)};
a.Ia[b]=c}return c?c:null}
function $h(a,b){var c="ytPlayer"+b+a.V;a.j[b]=c;l[c]=function(c){var e=H(function(){if(!a.isDisposed()){a.Z.w(b,c);var f=a.la,h=String(e);h in f&&delete f[h]}},0);
gb(a.la,String(e))};
return c}
...
g.Bd=function(){this.Sa||(of?(this.Ra=ne(document),Wf(this.H,window,"scroll",this.Wd),Wf(this.H,this.i,"touchmove",this.Qd)):(Wf(this.H,this.i,"mousewheel",this.nc),Wf(this.H,this.i,"wheel",this.nc)),this.Sa=!0)};
...
function Yh(a){zh("dcp");a.cancel();Nh(a);a.D=null;a.b&&(a.b.loaded=!1);var b=Vh(a);"html5"==Xh(a)?a.K=b:b&&b.destroy&&b.destroy();pe(a.i);Xf(a.ka);a.l=null;a.F=null}
g.cancel=function(){this.L&&xc(this.b.assets.js,this.L);I(this.Xb);this.ia=!1};
g.A=function(){Yh(this);if(this.K&&this.b)try{this.K.destroy()}catch(b){bc(b)}this.Ia=null;for(var a in this.j)l[this.j[a]]=null;this.Ta=this.b=this.f=null;delete this.i;delete this.o;Mh.B.A.call(this)};var ai={},bi="player_uid_"+(1E9*Math.random()>>>0);function ci(a,b){a=v(a)?ke(a):a;b=We(b);var c=bi+"_"+ha(a),d=ai[c];if(d)return d.Tb(b),d.f;d=new Mh(a,c);ai[c]=d;J("player-added",d.f);Ub(d,ma(di,d));H(function(){d.Tb(b)},0);
return d.f}
...
g.Ja=function(a,b,c){var d=gj(this,a),d=Ra([d],Va(arguments,1));this.Xc.apply(this,d)};
...
g.Ma=function(a){this.info("launchWithParams: "+L(a));this.i=a;this.b&&ll(this)};
...
this.Lb(b)},this))};function ql(a,b){hl.call(this,a,b,"ManualSession");this.b=H(w(this.Ma,this,null),150)}
y(ql,hl);ql.prototype.stop=function(){this.X()};
ql.prototype.Pb=t;ql.prototype.Ma=function(){I(this.b);this.b=NaN;var a=tk(this.F.W(),this.f.label);a?this.ob(a):this.X(Error("No such screen"))};
...
function vl(a,b,c){E(a.b);(a.b=b)?(c?a.w("yt-remote-cast2-receiver-resumed",b.f):a.w("yt-remote-cast2-receiver-selected",b.f),b.subscribe("sessionScreen",w(a.sc,a,b)),b.g?a.w("yt-remote-cast2-session-change",b.g):c&&a.b.Ma(null)):a.w("yt-remote-cast2-session-change",null)}
...
chrome.cast.ReceiverType.CAST&&(tl("onSessionEstablished_: manual to cast session change "+b.friendlyName),E(this.b),this.b=new jl(this.f,b),this.b.subscribe("sessionScreen",w(this.sc,this,this.b)),this.b.Ma(null));this.b.Pb(a)}}};
...
function Om(a,b,c){a.Pa=1;a.ra=Ug(b.clone());a.Fa=c;a.o=!0;Pm(a,null)}
function Qm(a,b,c,d,e){a.Pa=1;a.ra=Ug(b.clone());a.Fa=null;a.o=c;e&&(a.Ac=!1);Pm(a,d)}
...
function Nn(a,b){var c,d;b?6<a.xa?(a.f=a.i.concat(a.f),a.i.length=0,c=a.$a-1,d=Mn(a)):(c=b.u,d=b.Fa):(c=a.$a++,d=Mn(a));var e=a.ib.clone();N(e,"SID",a.g);N(e,"RID",c);N(e,"AID",a.La);Gn(a,e);c=new Lm(a,0,a.g,c,a.Xa+1);c.Aa=null;c.setTimeout(Math.round(1E4)+Math.round(1E4*Math.random()));a.T=c;Om(c,e,d)}
...
g.pc=function(a,b){if(0!=this.b&&(this.G==a||this.T==a))if(this.da=a.Za,this.T==a&&3==this.b)if(7<this.xa){var c;try{c=this.j.parse(b)}catch(f){c=null}if(u(c)&&3==c.length)if(0==c[0])a:{if(!this.oa){if(this.G)if(this.G.bb+3E3<this.T.bb)In(this),this.G.cancel(),this.G=null;else break a;Pn(this);X()}}else this.jc=c[1],0<this.jc-this.La&&37500>c[2]&&this.vb&&0==this.Ka&&!this.ya&&(this.ya=an(w(this.td,this),6E3));else ln(this,11)}else"y2f%"!=b&&ln(this,11);else if(this.G==a&&In(this),!/^[\s\xa0]*$/.test(b)){c=
...
Y.prototype.getProxyState=Y.prototype.Ha;Y.prototype.j=function(a){fo("Disconnecting with "+a);io(this);this.w("beforeDisconnect",a);1==a&&Ok();Wn(this.b,a);this.dispose()};
...
Y.prototype.sendMessage=Y.prototype.Ia;function uo(a){uk.call(this,"ScreenServiceProxy");this.R=a;this.b=[];this.b.push(this.R.$_s("screenChange",w(this.ue,this)));this.b.push(this.R.$_s("onlineScreenChange",w(this.Dd,this)))}
...
function sq(){var a=G("PLAYER_CONFIG",void 0);if("1"!=a.privembed)try{var b;try{var c=r("yt.www.ads.biscotti.getId_"),d;if(c)d=c();else{if(!Dp){var e=w(Hp,l,2);Dp=Ap().then(Ep,e)}d=Dp}b=d}catch(f){b=fg(f)}gg(b,null,Ip,void 0)}catch(f){bc(f)}if(G("REQUEST_POST_MESSAGE_ORIGIN")){if(!nq){nq=new ij;nq.b=sq;return}nq.origin&&"*"!=nq.origin&&(a.args.post_message_origin=nq.origin)}d=document.referrer;b=G("POST_MESSAGE_ORIGIN");c=!1;Yf("legacy_cast2")&&v(d)&&v(b)&&-1<d.indexOf(b)&&dh(b)&&dh(d)&&(c=!0);window!=
window.top&&d&&d!=document.URL&&(a.args.loaderUrl=d);G("LIGHTWEIGHT_AUTOPLAY")&&(a.args.autoplay="1");a.args.autoplay&&Hj(a.args);oq=ci("player",a);d=G("POST_MESSAGE_ID","player");G("ENABLE_JS_API")?qq=new up(oq):G("ENABLE_POST_API")&&v(d)&&v(b)&&(pq=new wp(window.parent,d,b),qq=new qp(oq,pq.f));Yf("legacy_cast2")&&((rq=c&&!G("ENABLE_CAST_API"))?a.args.disableCast="1":(a=oq,vo(),Xo=a,Xo.addEventListener("onReady",Zo),Xo.addEventListener("onRemoteReceiverSelected",ap),Yo.push(kc("yt-remote-receiver-availability-change",
$o)),Yo.push(kc("yt-remote-auto-connect",bp))));G("BG_P")&&(G("BG_I")||G("BG_IU"))&&zc();Yd();cp=oq;cp.addEventListener("SUBSCRIBE",fp);cp.addEventListener("UNSUBSCRIBE",ip);dp.push(oh(Ai,jp),oh(Fi,kp))}
